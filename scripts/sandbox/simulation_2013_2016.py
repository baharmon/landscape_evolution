...
def main():
    ...
    # for RUSLE3D simulation from 2013 to 2016
    rusle_3yr_params = {}
    rusle_3yr_params['elevation'] = 'elevation@{simulation}'.format(simulation=simulations[0])
    rusle_3yr_params['runs'] = 'series'
    rusle_3yr_params['mode'] = 'rusle_mode'
    rusle_3yr_params['precipitation'] = precipitation
    rusle_3yr_params['rain_interval'] = 60
    rusle_3yr_params['start'] = "2013-01-01 00:00:00"
    rusle_3yr_params['grav_diffusion'] = 0.05
    rusle_3yr_params['fluxmax'] = 0.25
    rusle_3yr_params['m'] = 0.4
    rusle_3yr_params['n'] = 1.3
    rusle_3yr_params['c_factor'] = 'c_factor'
    rusle_3yr_params['k_factor'] = 'k_factor'
    rusle_3yr_params['flags'] = 'f'
    rusle_3yr_params['env'] = envs['{simulation}'.format(simulation=simulations[0])]
    # append dictionary to options list
    options_list.append(rusle_3yr_params)
