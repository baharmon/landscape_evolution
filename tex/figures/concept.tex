...
\begin{tikzpicture}[scale=2, node distance = 1.75cm, auto]
	...
	\node [block, below of=erdep] (se) {landscape evolution};
	...
	\node [block, below of=dsf] (de) {landscape evolution};
	...
	\node [block, below of=tflowacc] (tls) {3D topographic factor};
	\node [block, below of=tls] (tsf) {sediment flow at transport capacity};
	\node [block, below of=tsf] (te) {landscape evolution};
