...
Steady state shallow water flow ${\bf q}$ is approximated by
the bivariate continuity equation (e.g., \cite{Julien1995}):
...
% with the direction given by the aspect angle 
