...
The following section explain the computation of $d_s$ for these three modes in more detail.
...
%($[s \; m^{-1}]$ for $p=1$),
$\tau=\rho_w\, g h  S  [Pa=kg \; m^{-2}]$ is the shear stress,
