...
%Determine mode \\
	% SIMWE, USPED, or RULSE3D \\
		%If SIMWE, then determine erosion regime \\
			% erosion deposition, detachment limited or transport limited\\
%Run erosion model \\
...
% regimes
	...
	%landscape evolution -- the change in elevation over time -- 
	%is a function of 
	%the net erosion-deposition rate and the sediment mass density.
	%etc...

% water flow

% sediment flux, transport limited erdep, or net erdep
