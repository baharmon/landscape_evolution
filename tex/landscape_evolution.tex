...
%a regional scale (650~\unit{km}$^{2}$) case study and
...
r.sim.water
%\footnote{\url{https://grass.osgeo.org/grass75/manuals/r.sim.water.html}} 
and r.sim.sediment.
%\footnote{\url{https://grass.osgeo.org/grass75/manuals/r.sim.sediment.html}}.
...
%\footnote{https://grass.osgeo.org/grass72/manuals/r.watershed.html}
...
\hspace*{0.5em} $R_e$ is the event-based erosivity factor [\unit{MJ~mm~ha}$^{-1}$~\unit{hr}$^{-1}$]\\ %~s{^-1}
