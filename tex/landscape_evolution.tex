...
for a subwatershed of Patterson Branch Creek, Fort Bragg, NC, USA. 
...
\caption{Subwatershed with 2014 orthoimagery draped over 2016 digital elevation model (a) and drainage areas with 2014 orthoimagery (b), Patterson Branch Creek, Fort Bragg, NC, USA}
\label{fig:watershed}
\end{figure}
...
%
The study landscape 
-- a subwatershed of Patterson Branch Creek (Figure~\ref{fig:watershed}a) 
...
using the RUSLE3D, USPED, and SIMWE models
...
\caption{Dynamic RUSLE3D (a-c) and USPED (d-f) simulations
...
for 120~\unit{min} events with rainfall intensities of 50~\unit{mm~hr}$^{-1}$ (a-c)
and 25~\unit{mm~hr}$^{-1}$(d-f)}
