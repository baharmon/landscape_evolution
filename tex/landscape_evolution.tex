...
\begin{tabu} to \textwidth {lXXX}
\toprule
Elevation A & Elevation B &  Correlation coeff. (R) & Difference from 2012-2016 baseline \\
\midrule
2012 & 2016 & 0.999329 & 0\\
2012 & simulated with RUSLE3D & 0.999848 & -0.000519\\
2012 & simulated with USPED & 0.999514 & -0.000185\\
2012 & simulated with SIMWE & 0.999333 & -0.000004\\
\bottomrule
\\
\end{tabu}
...
%
The results of the SIMWE simulation closely fit
the observed change in elevation between 2012-2016.
As expected given the current erosion regime for the study landscape 
the detachment capacity limited model, RUSLE3D, 
diverged the most from the baseline.
%
...
a variable erosion-deposition soil erosion regime. 
...
\caption{Bivariate scatterplots of the
(a) 2012 \& 2016 elevation maps, 
(b) 2012 \& RUSLE3D simulated elevation maps,  
(c) 2012 \& USPED simulated elevation maps, and
(d) 2012 \& SIMWE simulated elevation maps.}
...
The elevation change simulated with the SIMWE model
closely fit the observed change in the study landscape.
% empirical models
