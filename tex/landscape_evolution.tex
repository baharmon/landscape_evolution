...
\title{Gully: a short-term, dynamic landscape evolution model}

\author[la]{Brendan Harmon\corref{cor1}}
...
% cite anderson and anderson

% continuity / conservation
% source and sinks

% implications for erosion modeling
	% Simple empirical erosion models assume relatively steady erosion over time and estimate long-term, average annual erosion rates based on empirical factors derived from long- term observations. In reality, erosion rates change rapidly due to the highly dynamic nature of the driving forces, such as rainfall and water flow, over multiple temporal scales. The full dynamics of erosion processes are difficult to capture due to complex, multiscale interactions and limited temporal resolution of the input data. Therefore, modeling is commonly performed for the steady state case associated with peak flows during individual erosion events. Sophisticated modeling systems then perform continuous time simulations of several interacting processes that incorporate steady-state impacts of rainfall events over several years. (Mitasova et al. 2013)
...
Theoretically in an erosion-deposition regime
depositional ridges should form around the channel. % why?
...
% knickpoints: https://pubs.geoscienceworld.org/gsa/geosphere/article/8/2/403/132542/knickpoint-and-knickzone-formation-and-propagation

% high resolution topographic data
With sub-meter resolution topographic data from airborne lidar 
and unmanned aerial systems' (UAS) stereophotogrammetry 
it is now possible to morphometrically analyze and 
...
% dynamic landscape evolution model
	% restructure -> implementation as r.evolution
	% multi-scale model
	% with simwe mode that can switch between dynamic and steady state
...
%When transport capacity of overland flow exceeds its detach- ment capacity over the entire studied landscape, erosion, and sediment transport is detachment capacity limited (i.e., no deposition occurs). For example, this case is typical for sedi- ment transported by large amount of water over compacted soil. 
%
%If the soil detachment significantly exceeds the sediment transport capacity of overland flow, the sediment flow rate will be at the sediment transport capaci
% \cite{mitasova2013} 
...
\begin{itemize}
\small
\item How do erosional processes scale over time and space?
\item How do sediment detachment and transport interact?
\item Are dynamic flow regimes needed accurately simulate gully formation?
\end{itemize}

We compared a series of simulations against a times series of lidar surveys
to test the hypothesis that
dynamic models can more accurately simulate gully formation
than steady state models.

% that the model can accurately simulated measured change in a landscape

We hypothesize that the removal of forest cover
...
% other soil erosion models
    % list from table 1 or 2 in Brazier2013 Hillslope Soil Erosion Modeling
...
% --------------------------------EROSION-DEPOSITION --------------------------------
\section{Simulation of water erosion model} \label{simwe}
...
\clearpage
% -------------------------------- CASE STUDY--------------------------------
\section{Case study} %\subsection{Fort Bragg}

%\subsection{Patterson Branch Creek}
\subsection{Study landscape}
...
%
In 2016 the  450 x 450 meter study site was
...
%
%\multicolumn{1}{c}{\includegraphics[height=60mm]{../images/sample_data/naip_2014.png}} &
%\multicolumn{1}{c}{\includegraphics[height=60mm]{../images/sample_data/landcover.png}}\\
%\multicolumn{1}{c}{a. Orthophotograph} & \multicolumn{1}{c}{b. Landcover}\\
%
\multicolumn{1}{c}{\includegraphics[height=60mm]{../images/sample_data/elevation_2004.png}} &
\multicolumn{1}{c}{\includegraphics[height=60mm]{../images/sample_data/elevation_2016.png}}\\
\multicolumn{1}{c}{a. Elevation 2004} & \multicolumn{1}{c}{b. Elevation 2016}\\
%
\includegraphics[height=60mm,center]{../images/sample_data/landforms_2004.png} &
\includegraphics[height=60mm,center]{../images/sample_data/landforms_2016.png}\\
\multicolumn{1}{c}{c. Landforms 2004} & \multicolumn{1}{c}{d. Landforms 2016}\\
%
\multicolumn{1}{c}{\includegraphics[height=60mm]{../images/sample_data/depth_2016.png}} &
\multicolumn{1}{c}{\includegraphics[height=60mm]{../images/sample_data/difference_2004_2016.png}}\\
\multicolumn{1}{c}{e. Water depth for 10 min event with 50mm/hr} & \multicolumn{1}{c}{f. Difference 2004-2016}\\
%
\end{tabular}
...
% geomorphometry: http://geomorphometry.org/Geomorphometry_for_Geosciences_book.pdf
