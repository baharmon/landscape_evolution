...
or the Unit Stream Power Erosion Deposition (USPED) model (Fig.~\ref {fig:diagram}).  
...
The simulation modes in r.sim.terrain include (Fig.~\ref{fig:diagram}):
\begin{itemize}
...
%
The study landscape 
-- a subwatershed of Patterson Branch (Fig.~\ref{fig:watershed}) 
...
(Fig.~\ref{fig:study_area} \& \ref{fig:study_area_detail}). 
%
...
(Fig.~\ref{fig:study_area}c \& \ref{fig:study_area_detail}c) --
...
(Fig.~\ref{fig:simwe_simulation}a)
