...
def main():
    ...
    toggled_erdep_params = {}
    toggled_erdep_params['elevation'] = 'elevation@toggled_erdep'
    toggled_erdep_params['runs'] = 'event'
    toggled_erdep_params['mode'] = 'simwe_mode'
    toggled_erdep_params['rain_intensity'] = 50.0
    toggled_erdep_params['rain_duration'] = 60
    toggled_erdep_params['rain_interval'] = 60
    toggled_erdep_params['start'] = "2016-01-01 00:00:00"
    toggled_erdep_params['walkers'] = 5000000
    toggled_erdep_params['grav_diffusion'] = 0.05
    toggled_erdep_params['mannings'] = 'mannings'
    toggled_erdep_params['runoff'] = 'runoff'
    toggled_erdep_params['threads'] = threads
    toggled_erdep_params['env'] = envs['toggled_erdep']
    # append dictionary to options list
    options_list.append(toggled_erdep_params)

    # dictionary of parameters for steady state transport simulation
    toggled_transport_params = {}
    toggled_transport_params['elevation'] = 'elevation@toggled_transport'
    toggled_transport_params['runs'] = 'event'
    toggled_transport_params['mode'] = 'simwe_mode'
    toggled_transport_params['rain_intensity'] = 50.0
    toggled_transport_params['rain_duration'] = 60
    toggled_transport_params['rain_interval'] = 60
    toggled_transport_params['start'] = "2016-01-01 00:00:00"
    toggled_transport_params['walkers'] = 5000000
    toggled_transport_params['grav_diffusion'] = 0.05
    toggled_transport_params['transport_value'] = 0.01
    toggled_transport_params['detachment_value'] = 1.
    toggled_transport_params['mannings'] = 'mannings'
    toggled_transport_params['runoff'] = 'runoff'
    toggled_transport_params['threads'] = threads
    toggled_transport_params['env'] = envs['toggled_transport']
    # append dictionary to options list
    options_list.append(toggled_transport_params)

    # dictionary of parameters for steady state usped simulation
    toggled_usped_params = {}
    toggled_usped_params['elevation'] = 'elevation@toggled_usped'
    toggled_usped_params['runs'] = 'event'
    toggled_usped_params['mode'] = 'usped_mode'
    toggled_usped_params['rain_intensity'] = 50.0
    toggled_usped_params['rain_duration'] = 60
    toggled_usped_params['rain_interval'] = 60
    toggled_usped_params['start'] = "2016-01-01 00:00:00"
    toggled_usped_params['grav_diffusion'] = 0.05
    toggled_usped_params['m'] = 1.5
    toggled_usped_params['n'] = 1.2
    toggled_usped_params['c_factor'] = 'c_factor'
    toggled_usped_params['k_factor'] = 'k_factor'
    toggled_usped_params['env'] = envs['toggled_usped']
    # append dictionary to options list
    options_list.append(toggled_usped_params)
