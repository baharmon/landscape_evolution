...
simulations = ['erdep_12yr']

# set parameters
res = 1  # resolution of the region
region = 'elevation_2004@PERMANENT'
nprocs = 1
threads = 6
...
def main():
    ...
    # for erosion-deposition simulation from 2004 to 2016
    erdep_12yr_params = {}
    erdep_12yr_params['elevation'] = 'elevation@{simulation}'.format(simulation=simulations[0])
    erdep_12yr_params['runs'] = 'series'
    erdep_12yr_params['mode'] = 'simwe_mode'
    erdep_12yr_params['precipitation'] = precipitation
    erdep_12yr_params['rain_interval'] = 60
    erdep_12yr_params['start'] = "2004-01-01 00:00:00"
    erdep_12yr_params['walkers'] = 1000000
    erdep_12yr_params['grav_diffusion'] = 0.05
    erdep_12yr_params['density_value'] = 1.60
    erdep_12yr_params['erdepmin'] = -0.25
    erdep_12yr_params['erdepmax'] = 0.25
    erdep_12yr_params['fluxmax'] = 0.25
    erdep_12yr_params['mannings'] = 'mannings'
    erdep_12yr_params['runoff'] = 'runoff'
    erdep_12yr_params['threads'] = threads
    erdep_12yr_params['flags'] = 'f'
    erdep_12yr_params['env'] = envs['{simulation}'.format(simulation=simulations[0])]
    # append dictionary to options list
    options_list.append(erdep_12yr_params)
