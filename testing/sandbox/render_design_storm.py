...
# compute and render landforms
    ...
    gscript.run_command('d.shade',
        shade='shaded_relief',
        color='depth_2016_01_01_00_03_00',
        brighten=20)
    gscript.run_command('d.legend',
        raster='depth_2016_01_01_00_03_00',
        fontsize=fontsize,
        at=legend_coord)
    gscript.run_command('d.mon', stop=driver)
    ...
    # check for flux
    find_raster = gscript.find_file('flux_2016_01_01_00_03_00',
        element='cell')
    if find_raster['file']:
        # render flux
        gscript.run_command('d.mon',
        ...
        gscript.run_command('d.shade',
            shade='shaded_relief',
            color='flux_2016_01_01_00_03_00',
            brighten=20)
        gscript.run_command('d.legend',
            raster='flux_2016_01_01_00_03_00',
            fontsize=fontsize,
            at=legend_coord)
        gscript.run_command('d.mon', stop=driver)
