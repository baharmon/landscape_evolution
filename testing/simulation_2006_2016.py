...
precipitation = os.path.join(gisdbase, location, 'rain_events_2006_2016.csv')
...
def main():
    ...
    erdep_10_yr_params = {}
    erdep_10_yr_params['elevation'] = 'elevation@erdep_10_yr'
    erdep_10_yr_params['runs'] = 'series'
    erdep_10_yr_params['mode'] = 'simwe_mode'
    erdep_10_yr_params['precipitation'] = precipitation
    erdep_10_yr_params['rain_interval'] = 1
    erdep_10_yr_params['start'] = "2006-01-01 00:00:00"
    erdep_10_yr_params['walkers'] = 5000000
    erdep_10_yr_params['grav_diffusion'] = 0.1
    erdep_10_yr_params['mannings'] = 'mannings'
    erdep_10_yr_params['runoff'] = 'runoff'
    erdep_10_yr_params['threads'] = threads
    erdep_10_yr_params['env'] = envs['erdep_10_yr']
    # append dictionary to options list
    options_list.append(erdep_10_yr_params)
